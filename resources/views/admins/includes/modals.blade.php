@if (\App\Models\Permission::buttonPermission('btn-modal-view-admin'))
    <!-- visualizar administrador -->
    @include('admins.modals.view')
@endif

@if (\App\Models\Permission::buttonPermission('btn-modal-new-admin'))
    <!-- novo administrador -->
    @include('admins.modals.new')
    <script>
        $(function () {
...
@if (\App\Models\Permission::buttonPermission('btn-modal-edit-admin'))
    <!-- editar administrador -->
    @include('admins.modals.edit')
    <script>
        $(function () {
...
@if (\App\Models\Permission::buttonPermission('btn-modal-block-admin'))
    <!-- bloquear administrador -->
    @include('admins.modals.block')
    <script>
        $(function () {
...
@if (\App\Models\Permission::buttonPermission('btn-modal-delete-admin'))
    <!-- deletar administrador -->
    @include('admins.modals.delete')
    <script>
        $(function () {
...
@if (\App\Models\Permission::buttonPermission('btn-modal-recover-admin'))
    <!-- recuperar administrador -->
    @include('admins.modals.recover')
    <script>
        $(function () {
...
@if (\App\Models\Permission::buttonPermission('btn-send-email-admin'))
    <!-- enviar e-mail para o administrador -->
    @include('admins.modals.send-email')
    <script>
        $(function () {
