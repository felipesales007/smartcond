            ...
            <div class="modal-body">
                ...
                <form id="form-recover-admin" role="form" autocomplete="off" novalidate>
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-id-recover-admin">
                                    ...
                                    <input readonly type="number" id="id-recover-admin" name="id_recover_admin" class="form-control {{ $errors->has('id_recover_admin') ? 'is-invalid' : '' }}" placeholder="{{ __('ID do administrador') }}" value="{{ old('id_recover_admin') }}" maxlength="20" required onkeypress="return soNumeros(event);" @if ($errors->has('id_recover_admin')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-recover-admin">
                                    ...
                                    <input readonly type="text" id="name-recover-admin" name="name_recover_admin" class="form-control {{ $errors->has('name_recover_admin') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome do administrador') }}" value="{{ old('name_recover_admin') }}" minlength="3" maxlength="191" required onkeypress="return soLetras(event);" onkeyup="letraMaiuscula('name-recover-admin'); this.value = semEspaco(this.value);" @if ($errors->has('name_recover_admin')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-confirmation-recover-admin">
                                    ...
                                    <input type="text" id="name-confirmation-recover-admin" name="name_confirmation_recover_admin" class="form-control fe-block-paste {{ $errors->has('name_confirmation_recover_admin') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome para recuperação') }}" value="{{ old('name_confirmation_recover_admin') }}" minlength="3" maxlength="191" required onkeypress="return soLetras(event);" onkeyup="letraMaiuscula('name-confirmation-recover-admin'); this.value = semEspaco(this.value);" ondrop="return false;" @if ($errors->has('name_confirmation_recover_admin')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                    ...
                    <div class="text-right float-right fe-form-footer">
                        ...
                        @if (app('router')->has('admin.restore') && \App\Models\Permission::routePermission('admin.restore'))
