            ...
            <div class="modal-body">
                ...
                <form id="form-block-admin" role="form" autocomplete="off" novalidate>
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-id-block-admin">
                                    ...
                                    <input readonly type="number" id="id-block-admin" name="id_block_admin" class="form-control {{ $errors->has('id_block_admin') ? 'is-invalid' : '' }}" placeholder="{{ __('ID do administrador') }}" value="{{ old('id_block_admin') }}" maxlength="20" required onkeypress="return soNumeros(event);" @if ($errors->has('id_block_admin')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                                ...
                                <div class="input-group input-group-merge validate-blocked-at-block-admin">
                                    ...
                                    <div class="input-group-append" onclick="limparInputDatepicker(this);">
                                        <span class="input-group-text">
                                            <i id="blocked-at-block-admin-clean" class="fe-input-icone far fa-calendar-times"></i>
                                        </span>
                                    </div>
                                </div>
                                <!-- alerta de erro -->
                    ...
                    <div class="text-right float-right fe-form-footer">
                        ...
                        @if (app('router')->has('admin.block') && \App\Models\Permission::routePermission('admin.block'))
