            ...
            <div class="modal-body">
                ...
                <form id="form-send-email-admin" role="form" autocomplete="off" novalidate>
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-send-email-admin">
                                    ...
                                    <input readonly type="text" id="name-send-email-admin" name="name_send_email_admin" class="form-control {{ $errors->has('name_send_email_admin') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome completo') }}" value="{{ old('name_send_email_admin') }}" minlength="3" maxlength="191" required onkeypress="return soLetras(event);" onkeyup="letraMaiuscula('name-send-email-admin');" @if ($errors->has('name_send_email_admin')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                    ...
                    <div class="text-right float-right fe-form-footer">
                        ...
                        @if (app('router')->has('admin.send.email') && \App\Models\Permission::routePermission('admin.send.email'))
