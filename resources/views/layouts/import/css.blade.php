...
<link rel="stylesheet" href="{{ asset('argon/vendor/@fortawesome/fontawesome-free/css/animation.css') }}">
...
<!-- argon css -->
<link rel="stylesheet" href="{{ asset('argon/css/argon.min.css') }}">

<!-- desenvolvedor css -->
<link rel="stylesheet" href="{{ asset('css/argon.edited.css') }}">
