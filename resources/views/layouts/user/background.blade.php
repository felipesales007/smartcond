<!-- capa -->
<div class="header pb-8 pt-8 d-flex align-items-center fe-img-center" style="background-image: url({{ $user['background'] ? url('storage/img/users/background/' . $user['background']) : url('img/default/default-background.png') }});">
