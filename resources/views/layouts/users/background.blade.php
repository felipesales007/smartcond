<!-- capa -->
<div class="header pb-8 pt-8 d-flex align-items-center fe-img-center" style="background-image: url({{ $user['background'] ? url('storage/images/users/background/' . $user['background']) : url('images/default/default-background.png') }});">
