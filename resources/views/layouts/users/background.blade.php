<div class="header pb-9 pt-8 mb--8 align-items-center fe-img-center" style="background-image: url({{ $user['background'] ? url('storage/images/users/background/' . $user['background']) : url('images/default/default-background.png') }});">
