            ...
            <div class="modal-body">
                ...
                <form id="form-block-department" role="form" autocomplete="off" novalidate>
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-id-block-department">
                                    ...
                                    <input readonly type="number" id="id-block-department" name="id_block_department" class="form-control {{ $errors->has('id_block_department') ? 'is-invalid' : '' }}" placeholder="{{ __('ID do departamento') }}" value="{{ old('id_block_department') }}" maxlength="20" required onkeypress="return soNumeros(event);" @if ($errors->has('id_block_department')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                    ...
                    <div class="fe-mouse-off">
                        <div class="mt--1">
                            <small class="text-light">{{ __('bloqueie o departamento para ele ficar impossibilitado de ações') }}</small>
                        </div>
                    </div>
                    <!-- botões -->
                    <div class="text-right float-right fe-form-footer">
                        <a href="javascript:void(0)" class="mr-4" data-dismiss="modal">{{ __('Cancelar') }}</a>
                        @if (app('router')->has('department.block') && \App\Models\Permission::routePermission('department.block'))
