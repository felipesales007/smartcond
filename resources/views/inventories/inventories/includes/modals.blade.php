@if (\App\Models\Permission::buttonPermission('btn-modal-view-inventory'))
    <!-- visualizar inventário -->
    @include('inventories.inventories.modals.view')
@endif

@if (\App\Models\Permission::buttonPermission('btn-modal-new-inventory'))
    <!-- novo inventário -->
...
@if (\App\Models\Permission::buttonPermission('btn-modal-edit-inventory'))
    <!-- editar inventário -->
...
@if (\App\Models\Permission::buttonPermission('btn-modal-delete-inventory'))
    <!-- deletar inventário -->
...
@if (\App\Models\Permission::buttonPermission('btn-modal-recover-inventory'))
