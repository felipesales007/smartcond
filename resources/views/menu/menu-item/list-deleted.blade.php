@extends('layouts.app')
@section('title', __('Lista de itens do menu deletados'))
            ...
            <div class="col">
                ...
                <div class="card">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-5 col-sm-6">
                                <h3 class="text-uppercase text-monospace mb--1">
                                    <b>{{ __('Lista de itens do menu deletados') }}</b>
                                </h3>
                            </div>
                            <!-- botão -->
                            @if (app('router')->has('menu.item.store') && \App\Models\Permission::buttonPermission('btn-modal-new-menu-item') && \App\Models\Menu\MenuItem::getMenuItemDeleted('menu.item.store'))
                                <div class="col-7 col-sm-6 text-right">
                                    <a href="javascript:void(0)" class="btn btn-sm btn-icon btn-dark {{ \App\Models\Route\Route::getRouteBlocked('menu.item.store') ? 'notify-block-route' : 'btn-modal-new-menu-item' }} {{ \App\Models\Menu\MenuItem::getMenuItemBlocked('menu.item.store') ? 'opacity-2 disabled' : '' }}">
                    ...
                    <div class="table-responsive mb-2">
                        <table id="datatable-menu-items-deleted" class="table table-flush">
                            <!-- título da tabela -->
