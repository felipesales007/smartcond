            ...
            <div class="modal-body">
                ...
                <form id="form-edit-menu-item" role="form" autocomplete="off" novalidate>
                    ...
                    <div class="row">
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-id-edit-menu-item">
                                    ...
                                    <input readonly type="number" id="id-edit-menu-item" name="id_edit_menu_item" class="form-control {{ $errors->has('id_edit_menu_item') ? 'is-invalid' : '' }}" placeholder="{{ __('ID do item do menu') }}" value="{{ old('id_edit_menu_item') }}" maxlength="20" required onkeypress="return soNumeros(event);" @if ($errors->has('id_edit_menu_item')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-order-edit-menu-item">
                                    ...
                                    <input type="number" id="order-edit-menu-item" name="order_edit_menu_item" class="form-control {{ $errors->has('order_edit_menu_item') ? 'is-invalid' : '' }}" placeholder="{{ __('nº') }}" value="{{ old('order_edit_menu_item') }}" maxlength="10" required onkeypress="return soNumeros(event);" @if ($errors->has('order_edit_menu_item')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-8">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-button-edit-menu-item">
                                    ...
                                    <input type="text" id="button-edit-menu-item" name="button_edit_menu_item" class="form-control {{ $errors->has('button_edit_menu_item') ? 'is-invalid' : '' }}" placeholder="{{ __('Botão do item do menu') }}" value="{{ old('button_edit_menu_item') }}" minlength="3" maxlength="191" oninput="this.value = this.value.toLowerCase();" onkeypress="return caracteresGrupo(event);" @if ($errors->has('button_edit_menu_item')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                <label class="form-control-label" for="list-edit-menu-item">{{ __('Lista') }}</label>
                                <div class="input-group input-group-merge validate-list-edit-menu-item">
                                    ...
                                    <div class="custom-control custom-checkbox custom-checkbox-primary mt-2">
                                        <input type="checkbox" id="list-edit-menu-item" name="list_edit_menu_item" class="custom-control-input" {{ old('list_edit_menu_item') ? 'checked' : '' }}>
                                        <label class="custom-control-label" for="list-edit-menu-item"></label>
                                    </div>
                                </div>
                                <!-- alerta de erro -->
                                @if ($errors->has('list_edit_menu_item'))
                                    <div class="invalid-feedback" role="alert">{{ $errors->first('list_edit_menu_item') }}</div>
                                @endif
                            </div>
                        </div>
                        <!-- oculto -->
                    ...
                    <div class="text-right float-right fe-form-footer">
                        ...
                        @if (app('router')->has('menu.item.update') && \App\Models\Permission::routePermission('menu.item.update'))
