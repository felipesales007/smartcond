            ...
            <div class="modal-body">
                ...
                <form id="form-delete-menu" role="form" autocomplete="off" novalidate>
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-id-delete-menu">
                                    ...
                                    <input readonly type="number" id="id-delete-menu" name="id_delete_menu" class="form-control {{ $errors->has('id_delete_menu') ? 'is-invalid' : '' }}" placeholder="{{ __('ID do menu') }}" value="{{ old('id_delete_menu') }}" maxlength="20" required onkeypress="return soNumeros(event);" @if ($errors->has('id_delete_menu')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-delete-menu">
                                    ...
                                    <input readonly type="text" id="name-delete-menu" name="name_delete_menu" class="form-control {{ $errors->has('name_delete_menu') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome do menu') }}" value="{{ old('name_delete_menu') }}" minlength="3" maxlength="191" required onkeypress="return soLetras(event);" onkeyup="primeiraLetraMaiuscula(this);" @if ($errors->has('name_delete_menu')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-confirmation-delete-menu">
                                    ...
                                    <input type="text" id="name-confirmation-delete-menu" name="name_confirmation_delete_menu" class="form-control fe-block-paste {{ $errors->has('name_confirmation_delete_menu') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome para exclusão') }}" value="{{ old('name_confirmation_delete_menu') }}" minlength="3" maxlength="191" required onkeypress="return soLetras(event);" onkeyup="primeiraLetraMaiuscula(this);" ondrop="return false;" @if ($errors->has('name_confirmation_delete_menu')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                    ...
                    <div class="text-right float-right fe-form-footer">
                        ...
                        @if (app('router')->has('menu.destroy') && \App\Models\Permission::routePermission('menu.destroy'))
