            ...
            <div class="modal-body">
                ...
                <form id="form-edit-menu" role="form" autocomplete="off" novalidate>
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-id-edit-menu">
                                    ...
                                    <input readonly type="number" id="id-edit-menu" name="id_edit_menu" class="form-control {{ $errors->has('id_edit_menu') ? 'is-invalid' : '' }}" placeholder="{{ __('ID do menu') }}" value="{{ old('id_edit_menu') }}" maxlength="20" required onkeypress="return soNumeros(event);" @if ($errors->has('id_edit_menu')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-edit-menu">
                                    ...
                                    <input type="text" id="name-edit-menu" name="name_edit_menu" class="form-control {{ $errors->has('name_edit_menu') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome do menu') }}" value="{{ old('name_edit_menu') }}" minlength="3" maxlength="191" required onkeypress="return soLetras(event);" onkeyup="primeiraLetraMaiuscula(this);" @if ($errors->has('name_edit_menu')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-icon-edit-menu">
                                    ...
                                    <span class="fe-star" data-toggle="tooltip" data-placement="top" title="{{ __('no mínimo 3 caracteres') }}">*</span>
                                    <input type="text" id="icon-edit-menu" name="icon_edit_menu" class="form-control {{ $errors->has('icon_edit_menu') ? 'is-invalid' : '' }}" placeholder="{{ __('Ícone do menu') }}" value="{{ old('icon_edit_menu') }}" minlength="3" maxlength="191" required oninput="this.value = this.value.toLowerCase();" onkeypress="return caracteresIcone(event);" @if ($errors->has('icon_edit_menu')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-order-edit-menu">
                                    ...
                                    <input type="number" id="order-edit-menu" name="order_edit_menu" class="form-control {{ $errors->has('order_edit_menu') ? 'is-invalid' : '' }}" placeholder="{{ __('nº') }}" value="{{ old('order_edit_menu') }}" maxlength="10" required onkeypress="return soNumeros(event);" @if ($errors->has('order_edit_menu')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                    ...
                    <div class="text-right float-right fe-form-footer">
                        ...
                        @if (app('router')->has('menu.update') && \App\Models\Permission::routePermission('menu.update'))
