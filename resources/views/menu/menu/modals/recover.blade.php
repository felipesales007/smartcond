            ...
            <div class="modal-body">
                ...
                <form id="form-recover-menu" role="form" autocomplete="off" novalidate>
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-id-recover-menu">
                                    ...
                                    <input readonly type="number" id="id-recover-menu" name="id_recover_menu" class="form-control {{ $errors->has('id_recover_menu') ? 'is-invalid' : '' }}" placeholder="{{ __('ID do menu') }}" value="{{ old('id_recover_menu') }}" maxlength="20" required onkeypress="return soNumeros(event);" @if ($errors->has('id_recover_menu')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-recover-menu">
                                    ...
                                    <input readonly type="text" id="name-recover-menu" name="name_recover_menu" class="form-control {{ $errors->has('name_recover_menu') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome do menu') }}" value="{{ old('name_recover_menu') }}" minlength="3" maxlength="191" required onkeypress="return soLetras(event);" onkeyup="primeiraLetraMaiuscula(this);" @if ($errors->has('name_recover_menu')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-confirmation-recover-menu">
                                    ...
                                    <input type="text" id="name-confirmation-recover-menu" name="name_confirmation_recover_menu" class="form-control fe-block-paste {{ $errors->has('name_confirmation_recover_menu') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome para recuperação') }}" value="{{ old('name_confirmation_recover_menu') }}" minlength="3" maxlength="191" required onkeypress="return soLetras(event);" onkeyup="primeiraLetraMaiuscula(this);" ondrop="return false;" @if ($errors->has('name_confirmation_recover_menu')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                    ...
                    <div class="text-right float-right fe-form-footer">
                        ...
                        @if (app('router')->has('menu.restore') && \App\Models\Permission::routePermission('menu.restore'))
