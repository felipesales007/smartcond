            ...
            <div class="modal-body">
                ...
                <form id="form-block-menu" role="form" autocomplete="off" novalidate>
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-id-block-menu">
                                    ...
                                    <input readonly type="number" id="id-block-menu" name="id_block_menu" class="form-control {{ $errors->has('id_block_menu') ? 'is-invalid' : '' }}" placeholder="{{ __('ID do menu') }}" value="{{ old('id_block_menu') }}" maxlength="20" required onkeypress="return soNumeros(event);" @if ($errors->has('id_block_menu')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                    ...
                    <div class="text-right float-right fe-form-footer">
                        ...
                        @if (app('router')->has('menu.block') && \App\Models\Permission::routePermission('menu.block'))
