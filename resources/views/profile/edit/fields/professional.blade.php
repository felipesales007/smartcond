...
<div class="col-lg-6">
    <div class="form-group">
        ...
        <div class="input-group input-group-merge validate-profession-edit-profile">
            ...
            <input type="text" id="profession-edit-profile" name="profession_edit_profile" class="form-control {{ $errors->has('profession_edit_profile') ? 'is-invalid' : '' }}" placeholder="{{ __('Profissão') }}" value="{{ old('profession_edit_profile', auth()->user()['profession']) }}" minlength="3" maxlength="191" onkeyup="letterUppercase('profession-edit-profile');" @if ($errors->has('profession_edit_profile')) autofocus @endif>
        </div>
        <!-- alerta de erro -->
