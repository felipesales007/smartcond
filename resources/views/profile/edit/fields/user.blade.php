...
<div hidden class="col-lg-12">
    <div class="form-group">
        ...
        <div class="input-group input-group-merge validate-id-edit-profile">
            ...
            <input readonly type="number" id="id-edit-profile" name="id_edit_profile" class="form-control {{ $errors->has('id_edit_profile') ? 'is-invalid' : '' }}" placeholder="{{ __('ID do usuário') }}" value="{{ old('id_edit_profile', auth()->user()['id']) }}" maxlength="20" required onkeypress="return onlyNumbers(event);" @if ($errors->has('id_edit_profile')) autofocus @endif>
        </div>
        <!-- alerta de erro -->
...
<div class="col-lg-12">
    <div class="form-group">
        ...
        <div class="input-group input-group-merge validate-name-edit-profile">
            ...
            <input type="text" id="name-edit-profile" name="name_edit_profile" class="form-control {{ $errors->has('name_edit_profile') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome completo') }}" value="{{ old('name_edit_profile', auth()->user()['name']) }}" minlength="3" maxlength="191" required onkeypress="return onlyLetters(event);" onkeyup="letterUppercase('name-edit-profile');" @if ($errors->has('name_edit_profile')) autofocus @endif>
        </div>
        <!-- alerta de erro -->
...
<div class="col-lg-6">
    <div class="form-group">
        ...
        <div class="input-group input-group-merge validate-rg-edit-profile">
            ...
            <input type="tel" id="rg-edit-profile" name="rg_edit_profile" class="form-control {{ $errors->has('rg_edit_profile') ? 'is-invalid' : '' }}" placeholder="{{ __('RG') }}" value="{{ old('rg_edit_profile', auth()->user()['rg']) }}" minlength="8" maxlength="14" onkeypress="return onlyNumbers(event);" @if ($errors->has('rg_edit_profile')) autofocus @endif>
        </div>
        <!-- alerta de erro -->
...
<div class="col-lg-6">
    <div class="form-group">
        <label class="form-control-label" for="contact-edit-profile">{{ __('Telefone') }}</label>
...
<div class="col-lg-12">
    <div class="form-group">
        ...
        <div class="input-group-none validate-description-edit-profile">
            ...
            <textarea id="description-edit-profile" name="description_edit_profile" rows="3" resize="none" class="form-control {{ $errors->has('description_edit_profile') ? 'is-invalid' : '' }}" placeholder="{{ __('Descrição') }}" minlength="10" maxlength="1500" onkeyup="firstLetterUppercase(this);" @if ($errors->has('description_edit_profile')) autofocus @endif>{{ old('description_edit_profile', auth()->user()['description']) }}</textarea>
        </div>
        <!-- alerta de erro -->
