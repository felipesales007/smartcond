@if (\App\Models\Permission::buttonPermission('btn-modal-view-company'))
    <!-- visualizar empresa -->
    @include('companies.modals.view')
@endif

@if (\App\Models\Permission::buttonPermission('btn-modal-new-company'))
    <!-- nova empresa -->
    @include('companies.modals.new')
    <script>
        $(function () {
...
@if (\App\Models\Permission::buttonPermission('btn-modal-edit-company'))
    <!-- editar empresa -->
...
@if (\App\Models\Permission::buttonPermission('btn-modal-block-company'))
    <!-- bloquear empresa -->
    @include('companies.modals.block')
    <script>
        $(function () {
...
@if (\App\Models\Permission::buttonPermission('btn-modal-delete-company'))
    <!-- deletar empresa -->
...
@if (\App\Models\Permission::buttonPermission('btn-modal-recover-company'))
    <!-- recuperar empresa -->
...
@if (\App\Models\Permission::buttonPermission('btn-send-email-company'))
...
@if (\App\Models\Permission::buttonPermission('btn-modal-new-company-admin'))
    <!-- novo administrador -->
