                ...
                <form id="form-block-company" role="form" autocomplete="off" novalidate>
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-id-block-company">
                                    ...
                                    <input readonly type="number" id="id-block-company" name="id_block_company" class="form-control {{ $errors->has('id_block_company') ? 'is-invalid' : '' }}" placeholder="{{ __('ID do condomínio') }}" value="{{ old('id_block_company') }}" maxlength="20" required onkeypress="return soNumeros(event);" @if ($errors->has('id_block_company')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                            ...
                            <div class="form-group float-right mt--1 mb-0">
                                ...
                                <div class="input-group input-group-merge fe-toggle-line validate-blocked-block-company">
                                    <label class="custom-toggle custom-toggle-warning">
                                        <input type="checkbox" id="blocked-block-company" name="blocked_block_company" onchange="changeCheckbox(this, 'condomínio')">
                    ...
                    <div class="text-right float-right fe-form-footer">
                        ...
                        @if (app('router')->has('company.block') && \App\Models\Permission::routePermission('company.block'))
                            <button type="submit" id="btn-block-company" class="btn btn-outline-warning mr-4">{{ __('Bloquear condomínio') }}</button>
                        @endif
                    </div>
                </form>
            </div>
