            ...
            <div class="modal-body">
                ...
                <!-- inputs -->
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-id-edit-department">
                                    ...
                                    <input readonly type="number" id="id-edit-department" name="id_edit_department" class="form-control {{ $errors->has('id_edit_department') ? 'is-invalid' : '' }}" placeholder="{{ __('ID do departamento') }}" value="{{ old('id_edit_department') }}" maxlength="20" required onkeypress="return soNumeros(event);" @if ($errors->has('id_edit_department')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-edit-department">
                                    ...
                                    <input type="text" id="name-edit-department" name="name_edit_department" class="form-control {{ $errors->has('name_edit_department') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome do departamento') }}" value="{{ old('name_edit_department') }}" minlength="3" maxlength="191" required onkeypress="return soLetrasCaracteres(event);" onkeyup="letraMaiuscula('name-edit-department');" @if ($errors->has('name_edit_department')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                    ...
                    <div class="text-right float-right fe-form-footer">
                        ...
                        @if (app('router')->has('department.edit') && \App\Models\Permission::routePermission('department.edit'))
