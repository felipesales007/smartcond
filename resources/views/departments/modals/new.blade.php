            ...
            <div class="modal-body">
                ...
                <form id="form-new-department" role="form" autocomplete="off" novalidate>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-new-department">
                                    ...
                                    <input type="text" id="name-new-department" name="name_new_department" class="form-control {{ $errors->has('name_new_department') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome do departamento') }}" value="{{ old('name_new_department') }}" minlength="3" maxlength="191" required onkeypress="return soLetrasCaracteres(event);" onkeyup="letraMaiuscula('name-new-department');" @if ($errors->has('name_new_department')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                    ...
                    <div class="text-right float-right fe-form-footer">
                        ...
                        @if (app('router')->has('department.store') && \App\Models\Permission::routePermission('department.store'))
