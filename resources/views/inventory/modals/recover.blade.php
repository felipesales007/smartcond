                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-id-recover-company">
                                    ...
                                    <input readonly type="number" id="id-recover-company" name="id_recover_company" class="form-control {{ $errors->has('id_recover_company') ? 'is-invalid' : '' }}" placeholder="{{ __('ID da empresa') }}" value="{{ old('id_recover_company') }}" maxlength="20" required onkeypress="return soNumeros(event);" @if ($errors->has('id_recover_company')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
