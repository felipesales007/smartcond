                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-id-block-group">
                                    ...
                                    <input readonly type="number" id="id-block-group" name="id_block_group" class="form-control {{ $errors->has('id_block_group') ? 'is-invalid' : '' }}" placeholder="{{ __('ID do grupo') }}" value="{{ old('id_block_group') }}" maxlength="20" required onkeypress="return onlyNumbers(event);" @if ($errors->has('id_block_group')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
