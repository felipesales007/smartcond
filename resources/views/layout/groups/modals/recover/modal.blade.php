                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-id-recover-group">
                                    ...
                                    <input readonly type="number" id="id-recover-group" name="id_recover_group" class="form-control {{ $errors->has('id_recover_group') ? 'is-invalid' : '' }}" placeholder="{{ __('ID do grupo') }}" value="{{ old('id_recover_group') }}" maxlength="20" required onkeypress="return onlyNumbers(event);" @if ($errors->has('id_recover_group')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-recover-group">
                                    ...
                                    <input readonly type="text" id="name-recover-group" name="name_recover_group" class="form-control {{ $errors->has('name_recover_group') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome do grupo') }}" value="{{ old('name_recover_group') }}" minlength="3" maxlength="191" required oninput="this.value = this.value.toLowerCase();" onkeypress="return groupCharacters(event);" onkeyup="this.value = noSpace(this.value);" @if ($errors->has('name_recover_group')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-confirmation-recover-group">
                                    ...
                                    <input type="text" id="name-confirmation-recover-group" name="name_confirmation_recover_group" class="form-control fe-block-paste {{ $errors->has('name_confirmation_recover_group') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome para recuperação') }}" value="{{ old('name_confirmation_recover_group') }}" minlength="3" maxlength="191" required oninput="this.value = this.value.toLowerCase();" onkeypress="return groupCharacters(event);" onkeyup="this.value = noSpace(this.value);" ondrop="return false;" @if ($errors->has('name_confirmation_recover_group')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
