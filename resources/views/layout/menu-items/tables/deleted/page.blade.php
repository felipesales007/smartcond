@extends('layouts.app', ['sidebarMenu' => '7', 'sidebarItem' => '85'])
@section('title', \App\Models\Menu\MenuItem::getMenuItem(85)['name'])
...
@section('content')
    ...
    @include('layout.menu-items.tables.deleted.ajax')
    @include('layout.menu-items.tables.deleted.modal')
