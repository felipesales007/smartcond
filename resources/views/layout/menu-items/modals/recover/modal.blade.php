                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-confirmation-recover-menu-item">
                                    ...
                                    <input type="text" id="name-confirmation-recover-menu-item" name="name_confirmation_recover_menu_item" class="form-control fe-block-paste {{ $errors->has('name_confirmation_recover_menu_item') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome para recuperação') }}" value="{{ old('name_confirmation_recover_menu_item') }}" minlength="3" maxlength="191" required onkeypress="return onlyLettersCharacters(event);" onkeyup="firstLetterUppercase(this);" ondrop="return false;" @if ($errors->has('name_confirmation_recover_menu_item')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
