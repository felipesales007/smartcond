                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-id-block-menu-item">
                                    ...
                                    <input readonly type="number" id="id-block-menu-item" name="id_block_menu_item" class="form-control {{ $errors->has('id_block_menu_item') ? 'is-invalid' : '' }}" placeholder="{{ __('ID do item do menu') }}" value="{{ old('id_block_menu_item') }}" maxlength="20" required onkeypress="return onlyNumbers(event);" @if ($errors->has('id_block_menu_item')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
