            ...
            <div class="modal-body">
                ...
                <form id="form-new-menu-item" role="form" autocomplete="off" novalidate>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-new-menu-item">
                                    ...
                                    <input type="text" id="name-new-menu-item" name="name_new_menu_item" class="form-control {{ $errors->has('name_new_menu_item') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome do item do menu') }}" value="{{ old('name_new_menu_item') }}" minlength="3" maxlength="191" required onkeypress="return onlyLettersCharacters(event);" onkeyup="firstLetterUppercase(this);" @if ($errors->has('name_new_menu_item')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-order-new-menu-item">
                                    ...
                                    <input type="number" id="order-new-menu-item" name="order_new_menu_item" class="form-control {{ $errors->has('order_new_menu_item') ? 'is-invalid' : '' }}" placeholder="{{ __('nº') }}" value="{{ old('order_new_menu_item') }}" maxlength="10" required onkeypress="return onlyNumbers(event);" @if ($errors->has('order_new_menu_item')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-8">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-button-new-menu-item">
                                    ...
                                    <input type="text" id="button-new-menu-item" name="button_new_menu_item" class="form-control {{ $errors->has('button_new_menu_item') ? 'is-invalid' : '' }}" placeholder="{{ __('Botão do item do menu') }}" value="{{ old('button_new_menu_item') }}" minlength="3" maxlength="191" oninput="this.value = this.value.toLowerCase();" onkeypress="return groupCharacters(event);" @if ($errors->has('button_new_menu_item')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                <label class="form-control-label" for="main-new-menu-item">{{ __('Principal') }}</label>
                                <div class="input-group input-group-merge validate-main-new-menu-item">
                                    ...
                                    <div class="custom-control custom-checkbox custom-checkbox-primary mt-2">
                                        <input type="checkbox" id="main-new-menu-item" name="main_new_menu_item" class="custom-control-input" {{ old('main_new_menu_item') ? 'checked' : '' }}>
                                        <label class="custom-control-label" for="main-new-menu-item"></label>
                                    </div>
                                </div>
                                <!-- alerta de erro -->
                                @if ($errors->has('main_new_menu_item'))
                                    <div class="invalid-feedback" role="alert">{{ $errors->first('main_new_menu_item') }}</div>
                                @endif
                            </div>
                        </div>
                        <!-- oculto -->
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group-none validate-description-new-menu-item">
                                    ...
                                    <textarea id="description-new-menu-item" name="description_new_menu_item" rows="3" resize="none" class="form-control {{ $errors->has('description_new_menu_item') ? 'is-invalid' : '' }}" placeholder="{{ __('Descrição') }}" minlength="10" maxlength="1500" onkeyup="firstLetterUppercase(this);" @if ($errors->has('description_new_menu_item')) autofocus @endif>{{ old('description_new_menu_item') }}</textarea>
                                </div>
                                <!-- alerta de erro -->
