                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-id-recover-route">
                                    ...
                                    <input readonly type="number" id="id-recover-route" name="id_recover_route" class="form-control {{ $errors->has('id_recover_route') ? 'is-invalid' : '' }}" placeholder="{{ __('ID da rota') }}" value="{{ old('id_recover_route') }}" maxlength="20" required onkeypress="return onlyNumbers(event);" @if ($errors->has('id_recover_route')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-route-recover-route">
                                    ...
                                    <input readonly type="text" id="route-recover-route" name="route_recover_route" class="form-control {{ $errors->has('route_recover_route') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome da rota') }}" value="{{ old('route_recover_route') }}" minlength="3" maxlength="191" required oninput="this.value = this.value.toLowerCase();" onkeypress="return routeCharacters(event);" onkeyup="this.value = noSpace(this.value);" @if ($errors->has('route_recover_route')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-route-confirmation-recover-route">
                                    ...
                                    <input type="text" id="route-confirmation-recover-route" name="route_confirmation_recover_route" class="form-control fe-block-paste {{ $errors->has('route_confirmation_recover_route') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome para recuperação') }}" value="{{ old('route_confirmation_recover_route') }}" minlength="3" maxlength="191" required oninput="this.value = this.value.toLowerCase();" onkeypress="return routeCharacters(event);" onkeyup="this.value = noSpace(this.value);" ondrop="return false;" @if ($errors->has('route_confirmation_recover_route')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
