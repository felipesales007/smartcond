                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-id-delete-route">
                                    ...
                                    <input readonly type="number" id="id-delete-route" name="id_delete_route" class="form-control {{ $errors->has('id_delete_route') ? 'is-invalid' : '' }}" placeholder="{{ __('ID da rota') }}" value="{{ old('id_delete_route') }}" maxlength="20" required onkeypress="return onlyNumbers(event);" @if ($errors->has('id_delete_route')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-route-delete-route">
                                    ...
                                    <input readonly type="text" id="route-delete-route" name="route_delete_route" class="form-control {{ $errors->has('route_delete_route') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome da rota') }}" value="{{ old('route_delete_route') }}" minlength="3" maxlength="191" required oninput="this.value = this.value.toLowerCase();" onkeypress="return routeCharacters(event);" onkeyup="this.value = noSpace(this.value);" @if ($errors->has('route_delete_route')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-route-confirmation-delete-route">
                                    ...
                                    <input type="text" id="route-confirmation-delete-route" name="route_confirmation_delete_route" class="form-control fe-block-paste {{ $errors->has('route_confirmation_delete_route') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome para exclusão') }}" value="{{ old('route_confirmation_delete_route') }}" minlength="3" maxlength="191" required oninput="this.value = this.value.toLowerCase();" onkeypress="return routeCharacters(event);" onkeyup="this.value = noSpace(this.value);" ondrop="return false;" @if ($errors->has('route_confirmation_delete_route')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
