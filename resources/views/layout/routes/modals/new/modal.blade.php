                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-url-new-route">
                                    ...
                                    <input type="text" id="url-new-route" name="url_new_route" class="form-control {{ $errors->has('url_new_route') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome da url') }}" value="{{ old('url_new_route') }}" minlength="3" maxlength="191" required oninput="this.value = this.value.toLowerCase();" onkeypress="return urlCharacters(event);" onkeyup="this.value = noSpace(this.value);" @if ($errors->has('url_new_route')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-route-new-route">
                                    ...
                                    <input type="text" id="route-new-route" name="route_new_route" class="form-control {{ $errors->has('route_new_route') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome da rota') }}" value="{{ old('route_new_route') }}" minlength="3" maxlength="191" required oninput="this.value = this.value.toLowerCase();" onkeypress="return routeCharacters(event);" onkeyup="this.value = noSpace(this.value);" @if ($errors->has('route_new_route')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-controller-new-route">
                                    ...
                                    <input type="text" id="controller-new-route" name="controller_new_route" class="form-control {{ $errors->has('controller_new_route') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome do controle') }}" value="{{ old('controller_new_route') }}" minlength="3" maxlength="191" required onkeypress="return controlCharacters(event);" onkeyup="this.value = noSpace(this.value);" @if ($errors->has('controller_new_route')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group-none validate-description-new-route">
                                    ...
                                    <textarea id="description-new-route" name="description_new_route" rows="3" resize="none" class="form-control {{ $errors->has('description_new_route') ? 'is-invalid' : '' }}" placeholder="{{ __('Descrição') }}" minlength="10" maxlength="1500" onkeyup="firstLetterUppercase(this);" @if ($errors->has('description_new_route')) autofocus @endif>{{ old('description_new_route') }}</textarea>
                                </div>
                                <!-- alerta de erro -->
