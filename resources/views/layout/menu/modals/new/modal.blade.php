                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-new-menu">
                                    ...
                                    <input type="text" id="name-new-menu" name="name_new_menu" class="form-control {{ $errors->has('name_new_menu') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome do menu') }}" value="{{ old('name_new_menu') }}" minlength="3" maxlength="191" required onkeypress="return onlyLetters(event);" onkeyup="firstLetterUppercase(this);" @if ($errors->has('name_new_menu')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-icon-new-menu">
                                    ...
                                    <span class="fe-star" data-toggle="tooltip" data-placement="top" title="{{ __('no mínimo 3 caracteres') }}">*</span>
                                    <input type="text" id="icon-new-menu" name="icon_new_menu" class="form-control {{ $errors->has('icon_new_menu') ? 'is-invalid' : '' }}" placeholder="{{ __('Ícone do menu') }}" value="{{ old('icon_new_menu') }}" minlength="3" maxlength="191" required oninput="this.value = this.value.toLowerCase();" onkeypress="return charactersIcon(event);" @if ($errors->has('icon_new_menu')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-order-new-menu">
                                    ...
                                    <input type="number" id="order-new-menu" name="order_new_menu" class="form-control {{ $errors->has('order_new_menu') ? 'is-invalid' : '' }}" placeholder="{{ __('nº') }}" value="{{ old('order_new_menu') }}" maxlength="10" required onkeypress="return onlyNumbers(event);" @if ($errors->has('order_new_menu')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group-none validate-description-new-menu">
                                    ...
                                    <textarea id="description-new-menu" name="description_new_menu" rows="3" resize="none" class="form-control {{ $errors->has('description_new_menu') ? 'is-invalid' : '' }}" placeholder="{{ __('Descrição') }}" minlength="10" maxlength="1500" onkeyup="firstLetterUppercase(this);" @if ($errors->has('description_new_menu')) autofocus @endif>{{ old('description_new_menu') }}</textarea>
                                </div>
                                <!-- alerta de erro -->
