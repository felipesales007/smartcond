...
@section('content')
    ...
    @component('layouts.components.breadcrumbs')
        ...
        <li class="breadcrumb-item"><a href="{{ app('router')->has('inventory.category.list') ? route('inventory.category.list') : url('/') }}">{{ \App\Models\Menu\MenuItem::getMenuItem(93)['name'] }}</a></li>
