                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-id-recover-department">
                                    ...
                                    <input readonly type="number" id="id-recover-department" name="id_recover_department" class="form-control {{ $errors->has('id_recover_department') ? 'is-invalid' : '' }}" placeholder="{{ __('ID do departamento') }}" value="{{ old('id_recover_department') }}" maxlength="20" required onkeypress="return onlyNumbers(event);" @if ($errors->has('id_recover_department')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-recover-department">
                                    ...
                                    <input readonly type="text" id="name-recover-department" name="name_recover_department" class="form-control {{ $errors->has('name_recover_department') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome do departamento') }}" value="{{ old('name_recover_department') }}" minlength="3" maxlength="191" required onkeypress="return onlyLettersCharacters(event);" onkeyup="letterUppercase('name-recover-department');" @if ($errors->has('name_recover_department')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-confirmation-recover-department">
                                    ...
                                    <input type="text" id="name-confirmation-recover-department" name="name_confirmation_recover_department" class="form-control fe-block-paste {{ $errors->has('name_confirmation_recover_department') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome para recuperação') }}" value="{{ old('name_confirmation_recover_department') }}" minlength="3" maxlength="191" required onkeypress="return onlyLettersCharacters(event);" onkeyup="letterUppercase('name-confirmation-recover-department');" ondrop="return false;" @if ($errors->has('name_confirmation_recover_department')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
