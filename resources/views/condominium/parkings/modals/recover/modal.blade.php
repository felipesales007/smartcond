            ...
            <div class="modal-body">
                ...
                <form id="form-recover-condominium-parking" role="form" autocomplete="off" novalidate>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label class="form-control-label" for="name-confirmation-recover-condominium-parking">{{ __('Digite ') }}<b id="name-confirmation-recover-condominium-parking-text" class="text-success fe-parking-copy" onmousedown="return false;"></b>{{ __(' para confirmar a recuperação') }}</label>
