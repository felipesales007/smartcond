                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-new-condominium-block">
                                    ...
                                    <input type="text" id="name-new-condominium-block" name="name_new_condominium_block" class="form-control {{ $errors->has('name_new_condominium_block') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome ou número do bloco') }}" value="{{ old('name_new_condominium_block') }}" maxlength="191" required onkeypress="return onlyLettersNumbers(event);" onkeyup="letterUppercase('name-new-condominium-block');" @if ($errors->has('name_new_condominium_block')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
