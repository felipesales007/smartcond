...
@section('content')
            ...
            <div class="col">
                ...
                <div class="card">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-8">
                                <h3 class="text-uppercase text-monospace mb--1">
                                    <b>{{ __('Lista de apartamentos deletados') }}</b>
                                </h3>
                            </div>
                            <!-- botões -->
                    ...
                    <div class="table-responsive mb-2">
                        <table id="datatable-condominium-apartments-deleted" class="table table-flush">
                            <!-- título da tabela -->
    ...
    @include('condominium.apartments.tables.deleted.ajax')
    @include('condominium.apartments.tables.deleted.modal')
