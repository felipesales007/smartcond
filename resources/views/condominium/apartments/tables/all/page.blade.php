...
@section('content')
            ...
            <div class="col">
                ...
                <div class="card">
                    ...
                    <div class="table-responsive mb-2">
                        <table id="datatable-condominium-apartments" class="table table-flush">
                            <!-- título da tabela -->
    ...
    @include('condominium.apartments.tables.all.ajax')
    @include('condominium.apartments.tables.all.modal')
