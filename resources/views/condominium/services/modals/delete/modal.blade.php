    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 id="modal-delete-condominium-service-label" class="modal-title text-uppercase text-monospace ml-1">
                    <b>{{ __('Excluir prestador de serviços') }}</b>
                </h5>
            ...
            <div class="modal-body">
                <!-- form -->
                <form id="form-delete-condominium-service" role="form" autocomplete="off" novalidate>
                    @csrf
                    <!-- inputs -->
                    <div class="row">
                        <!-- id -->
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                <label class="form-control-label" for="id-delete-condominium-service">{{ __('ID') }}</label>
                                <div class="input-group input-group-merge validate-id-delete-condominium-service">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-lighter {{ $errors->has('id_delete_condominium_service') ? 'is-invalid' : '' }}">
                                            <i class="fas fa-key"></i>
                                        </span>
                                    </div>
                                    <span class="fe-star" data-toggle="tooltip" data-placement="top" title="{{ __('id do prestador de serviços') }}">*</span>
                                    <input readonly type="number" id="id-delete-condominium-service" name="id_delete_condominium_service" class="form-control {{ $errors->has('id_delete_condominium_service') ? 'is-invalid' : '' }}" placeholder="{{ __('ID do prestador de serviços') }}" value="{{ old('id_delete_condominium_service') }}" maxlength="20" required onkeypress="return onlyNumbers(event);" @if ($errors->has('id_delete_condominium_service')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                                @if ($errors->has('id_delete_condominium_service'))
                                    <div class="invalid-feedback" role="alert">{{ $errors->first('id_delete_condominium_service') }}</div>
                                @endif
                            </div>
                        </div>
                        <!-- nome -->
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                <label class="form-control-label" for="name-delete-condominium-service">{{ __('Nome') }}</label>
                                <div class="input-group input-group-merge validate-name-delete-condominium-service">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-lighter {{ $errors->has('name_delete_condominium_service') ? 'is-invalid' : '' }}">
                                ...
                                @if ($errors->has('name_delete_condominium_service'))
                                    <div class="invalid-feedback" role="alert">{{ $errors->first('name_delete_condominium_service') }}</div>
                                @endif
                            </div>
                        </div>
                        <!-- confirmação do nome -->
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                @if ($errors->has('name_confirmation_delete_condominium_service'))
                                    <div class="invalid-feedback" role="alert">{{ $errors->first('name_confirmation_delete_condominium_service') }}</div>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="fe-mouse">
                        ...
                        <br>
                        <div class="mt--1">
                            <small class="text-light">{{ __('pense bem antes de excluir, prestadores de serviços excluídos não são recuperados') }}</small>
                        </div>
                    </div>
                    <!-- botões -->
                    <div class="text-right float-right fe-form-footer">
                        <a href="javascript:void(0)" class="mr-4" data-dismiss="modal">{{ __('Cancelar') }}</a>
                        <button type="submit" id="btn-delete-condominium-service" class="btn btn-outline-danger mr-4">{{ __('Excluir prestador de serviços') }}</button>
                    </div>
                </form>
            </div>
        </div>
