...
@section('content')
            ...
            <div class="col">
                ...
                <div class="card">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-8">
                                <h3 class="text-uppercase text-monospace mb--1">
                                    <b>{{ __('Lista de prestadores de serviços deletados') }}</b>
                                </h3>
                            </div>
                            <!-- botões -->
                    ...
                    <div class="table-responsive mb-2">
                        <table id="datatable-condominium-services-deleted" class="table table-flush">
                            <!-- título da tabela -->
    ...
    @include('condominium.services.tables.deleted.ajax')
    @include('condominium.services.tables.deleted.modal')
