...
@section('content')
    ...
    @include('condominium.services.dashboard.cards')
            ...
            <div class="col">
                ...
                <div class="card">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-8">
                                <h3 class="text-uppercase text-monospace mb--1">
                                    <b>{{ __('Lista de prestadores de serviços') }}</b>
                                </h3>
                            </div>
                            <!-- botões -->
                    ...
                    <div class="table-responsive mb-2">
                        <table id="datatable-condominium-services" class="table table-flush">
                            <!-- título da tabela -->
                            <thead class="thead-light">
                                <tr>
                                    <th data-base="name">{{ __('Nome') }}</th>
                                    <th data-base="rg">{{ __('RG') }}</th>
                                    <th data-base="profession">{{ __('Profissão') }}</th>
    ...
    @include('condominium.services.tables.all.ajax')
    @include('condominium.services.tables.all.modal')
