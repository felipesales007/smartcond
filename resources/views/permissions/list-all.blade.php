@extends('layouts.app')
@section('title', __('Lista de usuários com permissões'))
            ...
            <div class="col">
                ...
                <div class="card">
                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-5 col-sm-6">
                                <h3 class="text-uppercase text-monospace mb--1">{{ __('Lista de usuários com permissões') }}</h3>
                            </div>
                            <!-- botão de voltar -->
                    ...
                    <div class="table-responsive mb-2">
                        <table id="datatable-permissions-users-all" class="table table-flush">
                            <!-- título da tabela -->
