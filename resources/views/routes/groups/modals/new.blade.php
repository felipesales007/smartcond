            ...
            <div class="modal-body">
                ...
                <form id="form-new-group" role="form" autocomplete="off" novalidate>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-new-group">
                                    ...
                                    <input type="text" id="name-new-group" name="name_new_group" class="form-control {{ $errors->has('name_new_group') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome do grupo') }}" value="{{ old('name_new_group') }}" minlength="3" maxlength="191" required oninput="this.value = this.value.toLowerCase();" onkeypress="return caracteresGrupo(event);" onkeyup="this.value = semEspaco(this.value);" @if ($errors->has('name_new_group')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                    ...
                    <div class="text-right float-right fe-form-footer">
                        ...
                        @if (app('router')->has('group.store') && \App\Models\Permission::routePermission('group.store'))
