            ...
            <div class="modal-body">
                ...
                <form id="form-delete-group" role="form" autocomplete="off" novalidate>
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-id-delete-group">
                                    ...
                                    <input readonly type="number" id="id-delete-group" name="id_delete_group" class="form-control {{ $errors->has('id_delete_group') ? 'is-invalid' : '' }}" placeholder="{{ __('ID do grupo') }}" value="{{ old('id_delete_group') }}" maxlength="20" required onkeypress="return soNumeros(event);" @if ($errors->has('id_delete_group')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-delete-group">
                                    ...
                                    <input readonly type="text" id="name-delete-group" name="name_delete_group" class="form-control {{ $errors->has('name_delete_group') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome do grupo') }}" value="{{ old('name_delete_group') }}" minlength="3" maxlength="191" required oninput="this.value = this.value.toLowerCase();" onkeypress="return caracteresGrupo(event);" onkeyup="this.value = semEspaco(this.value);" @if ($errors->has('name_delete_group')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-confirmation-delete-group">
                                    ...
                                    <input type="text" id="name-confirmation-delete-group" name="name_confirmation_delete_group" class="form-control fe-block-paste {{ $errors->has('name_confirmation_delete_group') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome para exclusão') }}" value="{{ old('name_confirmation_delete_group') }}" minlength="3" maxlength="191" required oninput="this.value = this.value.toLowerCase();" onkeypress="return caracteresGrupo(event);" onkeyup="this.value = semEspaco(this.value);" ondrop="return false;" @if ($errors->has('name_confirmation_delete_group')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                    ...
                    <div class="text-right float-right fe-form-footer">
                        ...
                        @if (app('router')->has('group.destroy') && \App\Models\Permission::routePermission('group.destroy'))
