            ...
            <div class="modal-body">
                ...
                <form id="form-edit-group" role="form" autocomplete="off" novalidate>
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-id-edit-group">
                                    ...
                                    <input readonly type="number" id="id-edit-group" name="id_edit_group" class="form-control {{ $errors->has('id_edit_group') ? 'is-invalid' : '' }}" placeholder="{{ __('ID do grupo') }}" value="{{ old('id_edit_group') }}" maxlength="20" required onkeypress="return soNumeros(event);" @if ($errors->has('id_edit_group')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-edit-group">
                                    ...
                                    <input type="text" id="name-edit-group" name="name_edit_group" class="form-control {{ $errors->has('name_edit_group') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome do grupo') }}" value="{{ old('name_edit_group') }}" minlength="3" maxlength="191" required oninput="this.value = this.value.toLowerCase();" onkeypress="return caracteresGrupo(event);" onkeyup="this.value = semEspaco(this.value);" @if ($errors->has('name_edit_group')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                    ...
                    <div class="text-right float-right fe-form-footer">
                        ...
                        @if (app('router')->has('group.update') && \App\Models\Permission::routePermission('group.update'))
