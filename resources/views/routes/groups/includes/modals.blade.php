@if (\App\Models\Permission::buttonPermission('btn-modal-view-group'))
    <!-- visualizar grupo -->
    @include('routes.groups.modals.view')
@endif

@if (\App\Models\Permission::buttonPermission('btn-modal-new-group'))
    <!-- novo grupo -->
    @include('routes.groups.modals.new')
    <script>
        $(function () {
...
@if (\App\Models\Permission::buttonPermission('btn-modal-edit-group'))
    <!-- editar grupo -->
    @include('routes.groups.modals.edit')
    <script>
        $(function () {
...
@if (\App\Models\Permission::buttonPermission('btn-modal-block-group'))
    <!-- bloquear grupo -->
    @include('routes.groups.modals.block')
    <script>
        $(function () {
...
@if (\App\Models\Permission::buttonPermission('btn-modal-delete-group'))
    <!-- deletar grupo -->
    @include('routes.groups.modals.delete')
    <script>
        $(function () {
...
@if (\App\Models\Permission::buttonPermission('btn-modal-recover-group'))
    <!-- recuperar grupo -->
    @include('routes.groups.modals.recover')
    <script>
        $(function () {
