@extends('layouts.app')
@section('title', __('Lista de rotas deletadas'))
                        ...
                        <div class="row align-items-center">
                            ...
                            @if (app('router')->has('route.store') && \App\Models\Permission::buttonPermission('btn-modal-new-route') && \App\Models\Menu\MenuItem::getMenuItemDeleted('route.store'))
                                <div class="col-7 col-sm-6 text-right">
                                    <a href="javascript:void(0)" class="btn btn-sm btn-icon btn-dark {{ \App\Models\Route\Route::getRouteBlocked('route.store') ? 'notify-block-route' : 'btn-modal-new-route' }} {{ \App\Models\Menu\MenuItem::getMenuItemBlocked('route.store') ? 'opacity-2 disabled' : '' }}">
