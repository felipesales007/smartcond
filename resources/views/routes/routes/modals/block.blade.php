            ...
            <div class="modal-body">
                ...
                <form id="form-block-route" role="form" autocomplete="off" novalidate>
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-id-block-route">
                                    ...
                                    <input readonly type="number" id="id-block-route" name="id_block_route" class="form-control {{ $errors->has('id_block_route') ? 'is-invalid' : '' }}" placeholder="{{ __('ID da rota') }}" value="{{ old('id_block_route') }}" maxlength="20" required onkeypress="return soNumeros(event);" @if ($errors->has('id_block_route')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                    ...
                    <div class="text-right float-right fe-form-footer">
                        ...
                        @if (app('router')->has('route.block') && \App\Models\Permission::routePermission('route.block'))
