            ...
            <div class="modal-body">
                ...
                <!-- inputs -->
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-id-edit-route">
                                    ...
                                    <input readonly type="number" id="id-edit-route" name="id_edit_route" class="form-control {{ $errors->has('id_edit_route') ? 'is-invalid' : '' }}" placeholder="{{ __('ID da rota') }}" value="{{ old('id_edit_route') }}" maxlength="20" required onkeypress="return soNumeros(event);" @if ($errors->has('id_edit_route')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-url-edit-route">
                                    ...
                                    <input type="text" id="url-edit-route" name="url_edit_route" class="form-control {{ $errors->has('url_edit_route') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome da url') }}" value="{{ old('url_edit_route') }}" minlength="3" maxlength="191" required oninput="this.value = this.value.toLowerCase();" onkeypress="return caracteresUrl(event);" onkeyup="this.value = semEspaco(this.value);" @if ($errors->has('url_edit_route')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-route-edit-route">
                                    ...
                                    <span class="fe-star" data-toggle="tooltip" data-placement="top" title="{{ __('no mínimo 3 caracteres') }}">*</span>
                                    <input type="text" id="route-edit-route" name="route_edit_route" class="form-control {{ $errors->has('route_edit_route') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome da rota') }}" value="{{ old('route_edit_route') }}" minlength="3" maxlength="191" required oninput="this.value = this.value.toLowerCase();" onkeypress="return caracteresRota(event);" onkeyup="this.value = semEspaco(this.value);" @if ($errors->has('route_edit_route')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                    ...
                    <div class="text-right float-right fe-form-footer">
                        ...
                        @if (app('router')->has('route.update') && \App\Models\Permission::routePermission('route.update'))
