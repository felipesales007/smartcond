                ...
                <form id="form-edit-user" role="form" autocomplete="off" novalidate>
                    ...
                    <div class="row">
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-id-edit-user">
                                    ...
                                    <input readonly type="number" id="id-edit-user" name="id_edit_user" class="form-control {{ $errors->has('id_edit_user') ? 'is-invalid' : '' }}" placeholder="{{ __('ID do usuário') }}" value="{{ old('id_edit_user') }}" maxlength="20" required onkeypress="return soNumeros(event);" @if ($errors->has('id_edit_user')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-edit-user">
                                    ...
                                    <input type="text" id="name-edit-user" name="name_edit_user" class="form-control {{ $errors->has('name_edit_user') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome completo') }}" value="{{ old('name_edit_user') }}" minlength="3" maxlength="191" required onkeypress="return soLetras(event);" onkeyup="letraMaiuscula('name-edit-user');" @if ($errors->has('name_edit_user')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-6 mb-4">
                            <a href="javascript:void(0)" id="event-edit-user-special-session" class="h5 text-muted fe-hover-color-theme" data-toggle="collapse" data-target="#collapse-edit-user-special-session" aria-expanded="false" aria-controls="collapse-edit-user-special-session">
                        ...
                        @if (app('router')->has('permission.user.edit') && \App\Models\Permission::routePermission('permission.user.edit'))
                            <div class="col-6 mb-4 mt-1">
                                <a href="javascript:void(0)" {{ $group || $route['blocked'] ? '' : 'id=link-permission-edit-user target=_blank' }} class="h5 text-muted fe-hover-color-theme float-right {{ $group ? 'notify-block-group' : '' }} {{ $route['blocked'] ? 'notify-block-route' : '' }} {{ \App\Models\Menu\Menu::getMenuBlocked('permission.user.edit') || \App\Models\Menu\MenuItem::getMenuItemBlocked('permission.user.edit') ? 'fe-menu-block' : '' }}">
                                            ...
                                            <div id="collapse-edit-user-special-session-2" class="collapse" aria-labelledby="heading-edit-user-special-session-2" data-parent="#accordion-edit-user-special-session">
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group input-group-merge validate-rg-edit-user">
                                                                    ...
                                                                    <input type="tel" id="rg-edit-user" name="rg_edit_user" class="form-control {{ $errors->has('rg_edit_user') ? 'is-invalid' : '' }}" placeholder="{{ __('RG') }}" value="{{ old('rg_edit_user') }}" minlength="8" maxlength="14" onkeypress="return soNumeros(event);" @if ($errors->has('rg_edit_user')) autofocus @endif>
                                                                </div>
                                                                <!-- alerta de erro -->
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <label class="form-control-label" for="contact-edit-user">{{ __('Contato') }}</label>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group input-group-merge validate-course-edit-user">
                                                                    ...
                                                                    <input type="text" id="course-edit-user" name="course_edit_user" class="form-control {{ $errors->has('course_edit_user') ? 'is-invalid' : '' }}" placeholder="{{ __('Curso') }}" value="{{ old('course_edit_user') }}" minlength="3" maxlength="191" onkeyup="letraMaiuscula('course-edit-user');" @if ($errors->has('course_edit_user')) autofocus @endif>
                                                                </div>
                                                                <!-- alerta de erro -->
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group input-group-merge validate-college-edit-user">
                                                                    ...
                                                                    <span class="fe-star fe-star-default" data-toggle="tooltip" data-placement="top" title="{{ __('no mínimo 3 caracteres') }}">*</span>
                                                                    <input type="text" id="college-edit-user" name="college_edit_user" class="form-control {{ $errors->has('college_edit_user') ? 'is-invalid' : '' }}" placeholder="{{ __('Faculdade') }}" value="{{ old('college_edit_user') }}" minlength="3" maxlength="191" onkeyup="letraMaiuscula('college-edit-user');" @if ($errors->has('college_edit_user')) autofocus @endif>
                                                                </div>
                                                                <!-- alerta de erro -->
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group input-group-merge validate-profession-edit-user">
                                                                    ...
                                                                    <span class="fe-star fe-star-default" data-toggle="tooltip" data-placement="top" title="{{ __('no mínimo 3 caracteres') }}">*</span>
                                                                    <input type="text" id="profession-edit-user" name="profession_edit_user" class="form-control {{ $errors->has('profession_edit_user') ? 'is-invalid' : '' }}" placeholder="{{ __('Profissão') }}" value="{{ old('profession_edit_user') }}" minlength="3" maxlength="191" onkeyup="letraMaiuscula('profession-edit-user');" @if ($errors->has('profession_edit_user')) autofocus @endif>
                                                                </div>
                                                                <!-- alerta de erro -->
                                                        ...
                                                        <div class="col-lg-7">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group input-group-merge validate-address-edit-user">
                                                                    ...
                                                                    <span class="fe-star fe-star-default" data-toggle="tooltip" data-placement="top" title="{{ __('no mínimo 3 caracteres') }}">*</span>
                                                                    <input type="text" id="address-edit-user" name="address_edit_user" class="form-control {{ $errors->has('address_edit_user') ? 'is-invalid' : '' }}" placeholder="{{ __('Endereço') }}" value="{{ old('address_edit_user') }}" minlength="3" maxlength="191" onkeyup="letraMaiuscula('address-edit-user');" @if ($errors->has('address_edit_user')) autofocus @endif>
                                                                </div>
                                                                <!-- alerta de erro -->
                                                        ...
                                                        <div class="col-lg-8">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group input-group-merge validate-complement-edit-user">
                                                                    ...
                                                                    <span class="fe-star fe-star-default" data-toggle="tooltip" data-placement="top" title="{{ __('no mínimo 3 caracteres') }}">*</span>
                                                                    <input type="text" id="complement-edit-user" name="complement_edit_user" class="form-control {{ $errors->has('complement_edit_user') ? 'is-invalid' : '' }}" placeholder="{{ __('Complemento') }}" value="{{ old('complement_edit_user') }}" minlength="3" maxlength="191" onkeyup="primeiraLetraMaiuscula(this);" @if ($errors->has('complement_edit_user')) autofocus @endif>
                                                                </div>
                                                                <!-- alerta de erro -->
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group input-group-merge validate-city-edit-user">
                                                                    ...
                                                                    <span class="fe-star fe-star-default" data-toggle="tooltip" data-placement="top" title="{{ __('no mínimo 3 caracteres') }}">*</span>
                                                                    <input type="text" id="city-edit-user" name="city_edit_user" class="form-control {{ $errors->has('city_edit_user') ? 'is-invalid' : '' }}" placeholder="{{ __('Cidade') }}" value="{{ old('city_edit_user') }}" onkeypress="return soLetras(event);" minlength="3" maxlength="191" onkeyup="letraMaiuscula('city-edit-user');" @if ($errors->has('city_edit_user')) autofocus @endif>
                                                                </div>
                                                                <!-- alerta de erro -->
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group input-group-merge validate-country-edit-user">
                                                                    ...
                                                                    <span class="fe-star fe-star-default" data-toggle="tooltip" data-placement="top" title="{{ __('no mínimo 3 caracteres') }}">*</span>
                                                                    <input type="text" id="country-edit-user" name="country_edit_user" class="form-control {{ $errors->has('country_edit_user') ? 'is-invalid' : '' }}" placeholder="{{ __('País') }}" value="{{ old('country_edit_user') }}" onkeypress="return soLetras(event);" minlength="3" maxlength="191" onkeyup="letraMaiuscula('country-edit-user');" @if ($errors->has('country_edit_user')) autofocus @endif>
                                                                </div>
                                                                <!-- alerta de erro -->
                    ...
                    <div class="text-right float-right fe-form-footer">
                        ...
                        @if (app('router')->has('user.update') && \App\Models\Permission::routePermission('user.update'))
