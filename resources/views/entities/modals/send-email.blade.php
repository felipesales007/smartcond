            ...
            <div class="modal-body">
                ...
                <form id="form-send-email-entity" role="form" autocomplete="off" novalidate>
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-send-email-entity">
                                    ...
                                    <input readonly type="text" id="name-send-email-entity" name="name_send_email_entity" class="form-control {{ $errors->has('name_send_email_entity') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome completo') }}" value="{{ old('name_send_email_entity') }}" minlength="3" maxlength="191" required onkeypress="return soLetras(event);" onkeyup="letraMaiuscula('name-send-email-entity');" @if ($errors->has('name_send_email_entity')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                    ...
                    <div class="text-right float-right fe-form-footer">
                        ...
                        @if (app('router')->has('entity.send.email') && \App\Models\Permission::routePermission('entity.send.email'))
