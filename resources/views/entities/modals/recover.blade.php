            ...
            <div class="modal-body">
                ...
                <form id="form-recover-entity" role="form" autocomplete="off" novalidate>
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-id-recover-entity">
                                    ...
                                    <input readonly type="number" id="id-recover-entity" name="id_recover_entity" class="form-control {{ $errors->has('id_recover_entity') ? 'is-invalid' : '' }}" placeholder="{{ __('ID do condomínio') }}" value="{{ old('id_recover_entity') }}" maxlength="20" required onkeypress="return soNumeros(event);" @if ($errors->has('id_recover_entity')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-recover-entity">
                                    ...
                                    <input readonly type="text" id="name-recover-entity" name="name_recover_entity" class="form-control {{ $errors->has('name_recover_entity') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome do condomínio') }}" value="{{ old('name_recover_entity') }}" minlength="3" maxlength="191" required onkeypress="return soLetrasCaracteres(event);" onkeyup="letraMaiuscula('name-recover-entity');" @if ($errors->has('name_recover_entity')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                    ...
                    <div class="text-right float-right fe-form-footer">
                        ...
                        @if (app('router')->has('entity.restore') && \App\Models\Permission::routePermission('entity.restore'))
