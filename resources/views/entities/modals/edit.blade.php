            ...
            <div class="modal-body">
                ...
                <form id="form-edit-entity" role="form" autocomplete="off" novalidate>
                    ...
                    <div class="row">
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-id-edit-entity">
                                    ...
                                    <input readonly type="number" id="id-edit-entity" name="id_edit_entity" class="form-control {{ $errors->has('id_edit_entity') ? 'is-invalid' : '' }}" placeholder="{{ __('ID do usuário') }}" value="{{ old('id_edit_entity') }}" maxlength="20" required onkeypress="return soNumeros(event);" @if ($errors->has('id_edit_entity')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-5">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-edit-entity">
                                    ...
                                    <input type="text" id="name-edit-entity" name="name_edit_entity" class="form-control {{ $errors->has('name_edit_entity') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome fantasia do condomínio') }}" value="{{ old('name_edit_entity') }}" minlength="3" maxlength="191" required onkeypress="return soLetrasCaracteres(event);" onkeyup="letraMaiuscula('name-edit-entity');" @if ($errors->has('name_edit_entity')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-5">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-corporate-name-edit-entity">
                                    ...
                                    <span class="fe-star" data-toggle="tooltip" data-placement="top" title="{{ __('no mínimo 3 caracteres') }}">*</span>
                                    <input type="text" id="corporate-name-edit-entity" name="corporate_name_edit_entity" class="form-control {{ $errors->has('corporate_name_edit_entity') ? 'is-invalid' : '' }}" placeholder="{{ __('Razão social do condomínio') }}" value="{{ old('corporate_name_edit_entity') }}" minlength="3" maxlength="191" required onkeypress="return soLetrasCaracteres(event);" onkeyup="letraMaiuscula('corporate-name-edit-entity');" @if ($errors->has('corporate_name_edit_entity')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label class="form-control-label" for="contact-edit-entity">{{ __('Contato') }}</label>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-complement-edit-entity">
                                    ...
                                    <input type="text" id="complement-edit-entity" name="complement_edit_entity" class="form-control {{ $errors->has('complement_edit_entity') ? 'is-invalid' : '' }}" placeholder="{{ __('Complemento') }}" value="{{ old('complement_edit_entity') }}" minlength="3" maxlength="191" onkeyup="primeiraLetraMaiuscula(this);" @if ($errors->has('complement_edit_entity')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-city-edit-entity">
                                    ...
                                    <span class="fe-star" data-toggle="tooltip" data-placement="top" title="{{ __('no mínimo 3 caracteres') }}">*</span>
                                    <input type="text" id="city-edit-entity" name="city_edit_entity" class="form-control {{ $errors->has('city_edit_entity') ? 'is-invalid' : '' }}" placeholder="{{ __('Cidade') }}" value="{{ old('city_edit_entity') }}" onkeypress="return soLetras(event);" minlength="3" maxlength="191" required onkeyup="letraMaiuscula('city-edit-entity');" @if ($errors->has('city_edit_entity')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-country-edit-entity">
                                    ...
                                    <span class="fe-star" data-toggle="tooltip" data-placement="top" title="{{ __('no mínimo 3 caracteres') }}">*</span>
                                    <input type="text" id="country-edit-entity" name="country_edit_entity" class="form-control {{ $errors->has('country_edit_entity') ? 'is-invalid' : '' }}" placeholder="{{ __('País') }}" value="{{ old('country_edit_entity') }}" onkeypress="return soLetras(event);" minlength="3" maxlength="191" required onkeyup="letraMaiuscula('country-edit-entity');" @if ($errors->has('country_edit_entity')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                    ...
                    <div class="text-right float-right fe-form-footer">
                        ...
                        @if (app('router')->has('entity.update') && \App\Models\Permission::routePermission('entity.update'))
