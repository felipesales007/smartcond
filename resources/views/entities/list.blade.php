            ...
            <div class="col">
                ...
                <div class="card">
                        ...
                        <div class="row align-items-center">
                            ...
                            @if (app('router')->has('entity.store') && \App\Models\Permission::buttonPermission('btn-modal-new-entity') && \App\Models\Menu\MenuItem::getMenuItemDeleted('entity.store'))
                                <div class="col-7 col-sm-6 text-right">
                                    <a href="javascript:void(0)" class="btn btn-sm btn-icon btn-dark {{ \App\Models\Route\Route::getRouteBlocked('entity.store') ? 'notify-block-route' : 'btn-modal-new-entity' }} {{ \App\Models\Menu\MenuItem::getMenuItemBlocked('entity.store') ? 'opacity-2 disabled' : '' }}">
                    ...
                    <div class="table-responsive mb-2">
                        <table id="datatable-entities" class="table table-flush">
                            <!-- título da tabela -->
