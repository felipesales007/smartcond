                ...
                <form id="form-edit-admin" role="form" autocomplete="off" novalidate>
                    ...
                    <div class="row">
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-id-edit-admin">
                                    ...
                                    <input readonly type="number" id="id-edit-admin" name="id_edit_admin" class="form-control {{ $errors->has('id_edit_admin') ? 'is-invalid' : '' }}" placeholder="{{ __('ID do administrador') }}" value="{{ old('id_edit_admin') }}" maxlength="20" required onkeypress="return onlyNumbers(event);" @if ($errors->has('id_edit_admin')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-edit-admin">
                                    ...
                                    <input type="text" id="name-edit-admin" name="name_edit_admin" class="form-control {{ $errors->has('name_edit_admin') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome completo') }}" value="{{ old('name_edit_admin') }}" minlength="3" maxlength="191" required onkeypress="return onlyLetters(event);" onkeyup="letterUppercase('name-edit-admin');" @if ($errors->has('name_edit_admin')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-6 mb-4">
                            <a href="javascript:void(0)" id="event-edit-admin-special-session" class="h5 text-muted text-primary fe-transition-default" data-toggle="collapse" data-target="#collapse-edit-admin-special-session" aria-expanded="false" aria-controls="collapse-edit-admin-special-session">
                        ...
                        @if (app('router')->has('permission.user.edit') && \App\Models\User\Permission::routePermission('permission.user.edit'))
                            <div class="col-6 mb-4 mt-1">
                                <a href="javascript:void(0)" {{ $group || $route['blocked'] ? '' : 'id=link-permission-edit-admin target=_blank' }} class="h5 text-muted text-primary fe-transition-default float-right {{ $group ? 'notify-block-group' : '' }} {{ $route['blocked'] ? 'notify-block-route' : '' }} {{ \App\Models\Menu\Menu::getMenuBlocked('permission.admin.edit') || \App\Models\Menu\MenuItem::getMenuItemBlocked('permission.admin.edit') ? 'fe-menu-block' : '' }}">
                                            ...
                                            <div id="collapse-edit-admin-special-session-2" class="collapse" aria-labelledby="heading-edit-admin-special-session-2" data-parent="#accordion-edit-admin-special-session">
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group input-group-merge validate-rg-edit-admin">
                                                                    ...
                                                                    <input type="tel" id="rg-edit-admin" name="rg_edit_admin" class="form-control {{ $errors->has('rg_edit_admin') ? 'is-invalid' : '' }}" placeholder="{{ __('RG') }}" value="{{ old('rg_edit_admin') }}" minlength="8" maxlength="14" onkeypress="return onlyNumbers(event);" @if ($errors->has('rg_edit_admin')) autofocus @endif>
                                                                </div>
                                                                <!-- alerta de erro -->
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <label class="form-control-label" for="contact-edit-admin">{{ __('Telefone') }}</label>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group input-group-merge validate-course-edit-admin">
                                                                    ...
                                                                    <input type="text" id="course-edit-admin" name="course_edit_admin" class="form-control {{ $errors->has('course_edit_admin') ? 'is-invalid' : '' }}" placeholder="{{ __('Curso') }}" value="{{ old('course_edit_admin') }}" minlength="3" maxlength="191" onkeyup="letterUppercase('course-edit-admin');" @if ($errors->has('course_edit_admin')) autofocus @endif>
                                                                </div>
                                                                <!-- alerta de erro -->
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group input-group-merge validate-college-edit-admin">
                                                                    ...
                                                                    <span class="fe-star fe-star-default" data-toggle="tooltip" data-placement="top" title="{{ __('no mínimo 3 caracteres') }}">*</span>
                                                                    <input type="text" id="college-edit-admin" name="college_edit_admin" class="form-control {{ $errors->has('college_edit_admin') ? 'is-invalid' : '' }}" placeholder="{{ __('Faculdade') }}" value="{{ old('college_edit_admin') }}" minlength="3" maxlength="191" onkeyup="letterUppercase('college-edit-admin');" @if ($errors->has('college_edit_admin')) autofocus @endif>
                                                                </div>
                                                                <!-- alerta de erro -->
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group input-group-merge validate-company-edit-admin">
                                                                    ...
                                                                    <span class="fe-star fe-star-default" data-toggle="tooltip" data-placement="top" title="{{ __('no mínimo 3 caracteres') }}">*</span>
                                                                    <input type="text" id="company-edit-admin" name="company_edit_admin" class="form-control {{ $errors->has('company_edit_admin') ? 'is-invalid' : '' }}" placeholder="{{ __('Empresa') }}" value="{{ old('company_edit_admin') }}" minlength="3" maxlength="191" onkeyup="letterUppercase('company-edit-admin');" @if ($errors->has('company_edit_admin')) autofocus @endif>
                                                                </div>
                                                                <!-- alerta de erro -->
                                                        ...
                                                        <div class="col-lg-7">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group input-group-merge validate-address-edit-admin">
                                                                    ...
                                                                    <span class="fe-star fe-star-default" data-toggle="tooltip" data-placement="top" title="{{ __('no mínimo 3 caracteres') }}">*</span>
                                                                    <input type="text" id="address-edit-admin" name="address_edit_admin" class="form-control {{ $errors->has('address_edit_admin') ? 'is-invalid' : '' }}" placeholder="{{ __('Endereço') }}" value="{{ old('address_edit_admin') }}" minlength="3" maxlength="191" onkeyup="letterUppercase('address-edit-admin');" @if ($errors->has('address_edit_admin')) autofocus @endif>
                                                                </div>
                                                                <!-- alerta de erro -->
                                                        ...
                                                        <div class="col-lg-8">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group input-group-merge validate-complement-edit-admin">
                                                                    ...
                                                                    <span class="fe-star fe-star-default" data-toggle="tooltip" data-placement="top" title="{{ __('no mínimo 3 caracteres') }}">*</span>
                                                                    <input type="text" id="complement-edit-admin" name="complement_edit_admin" class="form-control {{ $errors->has('complement_edit_admin') ? 'is-invalid' : '' }}" placeholder="{{ __('Complemento') }}" value="{{ old('complement_edit_admin') }}" minlength="3" maxlength="191" onkeyup="firstLetterUppercase(this);" @if ($errors->has('complement_edit_admin')) autofocus @endif>
                                                                </div>
                                                                <!-- alerta de erro -->
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group input-group-merge validate-city-edit-admin">
                                                                    ...
                                                                    <span class="fe-star fe-star-default" data-toggle="tooltip" data-placement="top" title="{{ __('no mínimo 3 caracteres') }}">*</span>
                                                                    <input type="text" id="city-edit-admin" name="city_edit_admin" class="form-control {{ $errors->has('city_edit_admin') ? 'is-invalid' : '' }}" placeholder="{{ __('Cidade') }}" value="{{ old('city_edit_admin') }}" onkeypress="return onlyLetters(event);" minlength="3" maxlength="191" onkeyup="letterUppercase('city-edit-admin');" @if ($errors->has('city_edit_admin')) autofocus @endif>
                                                                </div>
                                                                <!-- alerta de erro -->
