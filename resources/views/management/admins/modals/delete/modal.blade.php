                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-id-delete-admin">
                                    ...
                                    <input readonly type="number" id="id-delete-admin" name="id_delete_admin" class="form-control {{ $errors->has('id_delete_admin') ? 'is-invalid' : '' }}" placeholder="{{ __('ID do administrador') }}" value="{{ old('id_delete_admin') }}" maxlength="20" required onkeypress="return onlyNumbers(event);" @if ($errors->has('id_delete_admin')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-delete-admin">
                                    ...
                                    <input readonly type="text" id="name-delete-admin" name="name_delete_admin" class="form-control {{ $errors->has('name_delete_admin') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome do administrador') }}" value="{{ old('name_delete_admin') }}" minlength="3" maxlength="191" required onkeypress="return onlyLetters(event);" onkeyup="letterUppercase('name-delete-admin'); this.value = noSpace(this.value);" @if ($errors->has('name_delete_admin')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-confirmation-delete-admin">
                                    ...
                                    <input type="text" id="name-confirmation-delete-admin" name="name_confirmation_delete_admin" class="form-control fe-block-paste {{ $errors->has('name_confirmation_delete_admin') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome para exclusão') }}" value="{{ old('name_confirmation_delete_admin') }}" minlength="3" maxlength="191" required onkeypress="return onlyLetters(event);" onkeyup="letterUppercase('name-confirmation-delete-admin'); this.value = noSpace(this.value);" ondrop="return false;" @if ($errors->has('name_confirmation_delete_admin')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
