                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-new-admin">
                                    ...
                                    <input type="text" id="name-new-admin" name="name_new_admin" class="form-control {{ $errors->has('name_new_admin') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome completo') }}" value="{{ old('name_new_admin') }}" minlength="3" maxlength="191" required onkeypress="return onlyLetters(event);" onkeyup="letterUppercase('name-new-admin');" @if ($errors->has('name_new_admin')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
