                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-id-recover-user">
                                    ...
                                    <input readonly type="number" id="id-recover-user" name="id_recover_user" class="form-control {{ $errors->has('id_recover_user') ? 'is-invalid' : '' }}" placeholder="{{ __('ID do usuário') }}" value="{{ old('id_recover_user') }}" maxlength="20" required onkeypress="return onlyNumbers(event);" @if ($errors->has('id_recover_user')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-recover-user">
                                    ...
                                    <input readonly type="text" id="name-recover-user" name="name_recover_user" class="form-control {{ $errors->has('name_recover_user') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome do usuário') }}" value="{{ old('name_recover_user') }}" minlength="3" maxlength="191" required onkeypress="return onlyLetters(event);" onkeyup="letterUppercase('name-recover-user'); this.value = noSpace(this.value);" @if ($errors->has('name_recover_user')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-confirmation-recover-user">
                                    ...
                                    <input type="text" id="name-confirmation-recover-user" name="name_confirmation_recover_user" class="form-control fe-block-paste {{ $errors->has('name_confirmation_recover_user') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome para recuperação') }}" value="{{ old('name_confirmation_recover_user') }}" minlength="3" maxlength="191" required onkeypress="return onlyLetters(event);" onkeyup="letterUppercase('name-confirmation-recover-user'); this.value = noSpace(this.value);" ondrop="return false;" @if ($errors->has('name_confirmation_recover_user')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
