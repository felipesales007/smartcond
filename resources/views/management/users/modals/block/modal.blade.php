                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-id-block-user">
                                    ...
                                    <input readonly type="number" id="id-block-user" name="id_block_user" class="form-control {{ $errors->has('id_block_user') ? 'is-invalid' : '' }}" placeholder="{{ __('ID do usuário') }}" value="{{ old('id_block_user') }}" maxlength="20" required onkeypress="return onlyNumbers(event);" @if ($errors->has('id_block_user')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                                ...
                                <div class="input-group input-group-merge validate-blocked-at-block-user">
                                    ...
                                    <div class="input-group-append" onclick="clearInputDatepicker(this);">
                                        <span class="input-group-text">
                                            <i id="blocked-at-block-user-clean" class="fe-input-icon far fa-calendar-times"></i>
                                        </span>
                                    </div>
                                </div>
                                <!-- alerta de erro -->
