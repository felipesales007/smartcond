                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-send-email-user">
                                    ...
                                    <input readonly type="text" id="name-send-email-user" name="name_send_email_user" class="form-control {{ $errors->has('name_send_email_user') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome completo') }}" value="{{ old('name_send_email_user') }}" minlength="3" maxlength="191" required onkeypress="return onlyLetters(event);" onkeyup="letterUppercase('name-send-email-user');" @if ($errors->has('name_send_email_user')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
