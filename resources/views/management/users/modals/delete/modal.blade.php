                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-id-delete-user">
                                    ...
                                    <input readonly type="number" id="id-delete-user" name="id_delete_user" class="form-control {{ $errors->has('id_delete_user') ? 'is-invalid' : '' }}" placeholder="{{ __('ID do usuário') }}" value="{{ old('id_delete_user') }}" maxlength="20" required onkeypress="return onlyNumbers(event);" @if ($errors->has('id_delete_user')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-confirmation-delete-user">
                                    ...
                                    <input type="text" id="name-confirmation-delete-user" name="name_confirmation_delete_user" class="form-control fe-block-paste {{ $errors->has('name_confirmation_delete_user') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome para exclusão') }}" value="{{ old('name_confirmation_delete_user') }}" minlength="3" maxlength="191" required onkeypress="return onlyLetters(event);" onkeyup="letterUppercase('name-confirmation-delete-user'); this.value = noSpace(this.value);" ondrop="return false;" @if ($errors->has('name_confirmation_delete_user')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
