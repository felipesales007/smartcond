                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-id-block-company">
                                    ...
                                    <input readonly type="number" id="id-block-company" name="id_block_company" class="form-control {{ $errors->has('id_block_company') ? 'is-invalid' : '' }}" placeholder="{{ __('ID da empresa') }}" value="{{ old('id_block_company') }}" maxlength="20" required onkeypress="return onlyNumbers(event);" @if ($errors->has('id_block_company')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                                ...
                                <div class="input-group input-group-merge validate-blocked-at-block-company">
                                    ...
                                    <div class="input-group-append" onclick="clearInputDatepicker(this);">
                                        <span class="input-group-text">
                                            <i id="blocked-at-block-company-clean" class="fe-input-icon far fa-calendar-times"></i>
                                        </span>
                                    </div>
                                </div>
                                <!-- alerta de erro -->
