                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-send-email-company">
                                    ...
                                    <input readonly type="text" id="name-send-email-company" name="name_send_email_company" class="form-control {{ $errors->has('name_send_email_company') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome completo') }}" value="{{ old('name_send_email_company') }}" minlength="3" maxlength="191" required onkeypress="return onlyLetters(event);" onkeyup="letterUppercase('name-send-email-company');" @if ($errors->has('name_send_email_company')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
