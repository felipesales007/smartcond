                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-id-delete-company">
                                    ...
                                    <input readonly type="number" id="id-delete-company" name="id_delete_company" class="form-control {{ $errors->has('id_delete_company') ? 'is-invalid' : '' }}" placeholder="{{ __('ID da empresa') }}" value="{{ old('id_delete_company') }}" maxlength="20" required onkeypress="return onlyNumbers(event);" @if ($errors->has('id_delete_company')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-delete-company">
                                    ...
                                    <input readonly type="text" id="name-delete-company" name="name_delete_company" class="form-control {{ $errors->has('name_delete_company') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome da empresa') }}" value="{{ old('name_delete_company') }}" minlength="3" maxlength="191" required onkeypress="return onlyLettersCharacters(event);" onkeyup="letterUppercase('name-delete-company');" @if ($errors->has('name_delete_company')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-confirmation-delete-company">
                                    ...
                                    <input type="text" id="name-confirmation-delete-company" name="name_confirmation_delete_company" class="form-control fe-block-paste {{ $errors->has('name_confirmation_delete_company') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome para exclusão') }}" value="{{ old('name_confirmation_delete_company') }}" minlength="3" maxlength="191" required onkeypress="return onlyLettersCharacters(event);" onkeyup="letterUppercase('name-confirmation-delete-company');" ondrop="return false;" @if ($errors->has('name_confirmation_delete_company')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
