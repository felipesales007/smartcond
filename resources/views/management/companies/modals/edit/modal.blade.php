            ...
            <div class="modal-body">
                ...
                <form id="form-edit-company" role="form" autocomplete="off" novalidate>
                    ...
                    <div class="row">
                        ...
                        <div hidden class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-id-edit-company">
                                    ...
                                    <input readonly type="number" id="id-edit-company" name="id_edit_company" class="form-control {{ $errors->has('id_edit_company') ? 'is-invalid' : '' }}" placeholder="{{ __('ID do usuário') }}" value="{{ old('id_edit_company') }}" maxlength="20" required onkeypress="return onlyNumbers(event);" @if ($errors->has('id_edit_company')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-5">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-name-edit-company">
                                    ...
                                    <input type="text" id="name-edit-company" name="name_edit_company" class="form-control {{ $errors->has('name_edit_company') ? 'is-invalid' : '' }}" placeholder="{{ __('Nome fantasia da empresa') }}" value="{{ old('name_edit_company') }}" minlength="3" maxlength="191" required onkeypress="return onlyLettersCharacters(event);" onkeyup="letterUppercase('name-edit-company');" @if ($errors->has('name_edit_company')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label class="form-control-label" for="contact-edit-company">{{ __('Telefone') }}</label>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge validate-country-edit-company">
                                    ...
                                    <span class="fe-star" data-toggle="tooltip" data-placement="top" title="{{ __('no mínimo 3 caracteres') }}">*</span>
                                    <input type="text" id="country-edit-company" name="country_edit_company" class="form-control {{ $errors->has('country_edit_company') ? 'is-invalid' : '' }}" placeholder="{{ __('País') }}" value="{{ old('country_edit_company') }}" onkeypress="return onlyLetters(event);" minlength="3" maxlength="191" required onkeyup="letterUppercase('country-edit-company');" @if ($errors->has('country_edit_company')) autofocus @endif>
                                </div>
                                <!-- alerta de erro -->
