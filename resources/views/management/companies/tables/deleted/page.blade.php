@extends('layouts.app', ['sidebarMenu' => '6', 'sidebarItem' => '30'])
@section('title', \App\Models\Menu\MenuItem::getMenuItem(30)['name'])
...
@section('content')
    ...
    @include('management.companies.tables.deleted.ajax')
    @include('management.companies.tables.deleted.modal')
