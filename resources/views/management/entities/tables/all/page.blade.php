@extends('layouts.app', ['sidebarMenu' => '6', 'sidebarItem' => '41'])
@section('title', \App\Models\Menu\MenuItem::getMenuItem(41)['name'])
...
@section('content')
    ...
    @include('management.entities.tables.all.ajax')
    @include('management.entities.tables.all.modal')
