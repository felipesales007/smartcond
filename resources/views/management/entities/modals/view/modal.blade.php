        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row fe-mouse">
                    <!-- status, logo, nome, e-mail e telefone -->
                    <div class="col-lg-12">
                        <!-- status -->
                        ...
                        <!-- logo -->
                        <div id="logo-view-entity" class="fe-img-center avatar-xl fe-avatar-border fe-radius mt--5-9"></div>
                        <!-- nome -->
                    ...
                    <!-- cnpj -->
                    <div class="col-lg-12">
                        <i id="icon-profession-view-entity" class="fas fa-credit-card mr-1"></i>
                ...
                <div class="text-right float-right fe-form-footer">
                    ...
                    @if (app('router')->has('entity.list.users') && \App\Models\User\Permission::routePermission('entity.list.users'))
