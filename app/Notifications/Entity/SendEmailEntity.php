...
class SendEmailEntity extends Notification
{
    use Queueable;
    ...
    /**
     * Construtor SendEmailEntity.
     *
     * @param $collection
     */
    public function __construct($collection)
    {
        $this->name    = $collection['name_send_email_entity'];
        $this->message = $collection['message_send_email_entity'];
    }
