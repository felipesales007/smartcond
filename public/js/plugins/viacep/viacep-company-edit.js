...
function limpaFormCepCompanyEdit() {
    let screen = '-edit-company';
...
$(document).on('focusout', '#postal-code-edit-company', function () {
    let screen = '-edit-company';
...
cepCompanyEdit = conteudo => {
    ...
    if (!('erro' in conteudo)) {
        ...
        returnStateIdCompanyEdit(conteudo);
        ...
        limpaFormCepCompanyEdit();
    }
};

// pesquisa o cep inserido
function viacepCompanyEdit(valor) {
    ...
    if (cep !== '') {
        ...
        if (validacep.test(cep)) {
            ...
            script.src = 'https://viacep.com.br/ws/' + cep + '/json/?callback=cepCompanyEdit';
...
function returnStateIdCompanyEdit(conteudo) {
    let screen = '-edit-company';
    let state_id;
